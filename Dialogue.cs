...
namespace Phantom
{
    public class Dialogue
    {
        ...
        public static List<String[]> Dialogues = new List<string[]>
        {
            ...
            {
            "r0gu3: Hello, Joan. Pleasure to be working with you again.",
            "j0an: What's the mission?",
            ...
            "j0an: What’s the quickest entrance?",
            ...
            {
            "j0an: I’m in. Where do I proceed?",
            "ap0c: Nicely done.",
            ...
            {
                "ap0c: Joan? You there?",
                "j0an: ...They’re experimenting on humans illegally here…",
                "j0an: Innocent people—they’re lying to them about what’s going to happen—",
                "ap0c: --Joan, we were explicitly instructed to only take the blueprints.",
                "j0an: So, you want me to just pretend like I saw nothing?",
            ...
            new string[] // 7 - expose
            {
                ...
                "j0an: I’m sorry, Apoc.",
                "ap0c: JOAN, DON’T ---",
                "j0an: I have to prioritize what I believe in.",
                "j0an: Even if that costs me.",
            ...
            {
                "j0an: I’ve taken the blueprints.",
                "ap0c: Good. We stick to the plan. No heroics.",
                "j0an: It just.. feels wrong.",
