...
Користен е фонт кој што не доаѓа стандардно со windows, се препорачува да се инсталира фонтот unispace bold кој се наоѓа во фолдерот bin/resources. Во случај да не е инсталиран фонтот играта користи default фонт.
